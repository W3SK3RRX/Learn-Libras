...
<!-- ============================================== --> 
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div class="col-10 col-sm-8 col-lg-6">
        <video class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy" controls>
          <source src="Conteudos/videos/v3.mp4" type="video/mp4">
        </video>
      </div>
      <div class="col-lg-6">
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" >
            <h3 class="display-5 fw-bold">Exercício 3</h3>
  ...
  <div class="container col-xxl-8 px-4 py-5">
    <p class="lead">Parabéns!!!<br>Você concluiu essa etapa do curso, clique em voltar para retornar a tela inicial.</p>
    <a href="area_curso.php"><button class="w-25 btn btn-lg btn btn-warning center">Voltar</button></a>
  </div>
