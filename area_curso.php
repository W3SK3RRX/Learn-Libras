...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3">
      <h2 class="pb-2 border-bottom">Conteúdos</h2>
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        <div class="feature col">
          <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
          </div>
          <h3 class="fs-2">Alfabeto manual</h3>
          <p>No primeiro material do curso vamos falar sobre o alfabeto manual, que tem
             como função auxiliar na intercomunicação entre duas línguas diferentes, a
             oral e a de sinais, portanto é uma ferramenta muito útil no aprendizado da
             língua de sinais.</p>
          <a href="alfabeto.php"><button type="button" class="btn btn-warning">Acessar</button></a>
        </div>
        <div class="feature col">
          <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
          </div>
          <h3 class="fs-2">XXXXXXXXX</h3>
          <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
          <a href=""><button type="button" class="btn btn-warning">Acessar</button></a>
        </div>
        <div class="feature col">
          <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
          </div>
